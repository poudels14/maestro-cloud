...
export const STATUS_COLORS: Record<string, { dot: string; pill: string }> = {
  ...
  PREPARING: { dot: "bg-amber-400", pill: "bg-amber-50 text-amber-700 border-amber-100" },
  ...
  STARTING: { dot: "bg-sky-400", pill: "bg-sky-50 text-sky-700 border-sky-100" },
  PENDING_READY: { dot: "bg-brand", pill: "bg-brand-light text-brand-hover border-brand-ring" },
  RETRYING: { dot: "bg-amber-400", pill: "bg-amber-50 text-amber-700 border-amber-100" },
  READY: { dot: "bg-emerald-400", pill: "bg-emerald-100 text-emerald-800 border-emerald-200" },
  RECOVERING: { dot: "bg-amber-400", pill: "bg-amber-50 text-amber-700 border-amber-100" },
  STOPPING: { dot: "bg-gray-400", pill: "bg-gray-100 text-gray-500 border-gray-200" },

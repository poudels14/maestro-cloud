      ...
      <div class="grid gap-2.5">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
          <input
            ...
            class="w-full px-2.5 py-1.5 text-sm text-gray-800 border border-gray-200 bg-white rounded-md outline-none focus:border-brand focus:ring-2 focus:ring-brand-ring disabled:bg-gray-100"
          />
          <input
            type="text"
            ...
            class="w-full px-2.5 py-1.5 text-sm text-gray-800 border border-gray-200 bg-white rounded-md outline-none focus:border-brand focus:ring-2 focus:ring-brand-ring"
          />
        </div>
        <select
          value={format()}
        ...
        <input
          ...
          disabled={mutation.isPending}
          autocomplete="off"
          class="w-full px-2.5 py-1.5 text-sm font-mono text-gray-800 border border-gray-200 bg-white rounded-md outline-none focus:border-brand focus:ring-2 focus:ring-brand-ring"
        />
        ...
        <div class="flex items-center gap-2 mt-1">
          <button
            ...
            onClick={save}
            disabled={mutation.isPending}
            class="px-3 py-1.5 text-xs font-medium rounded-md bg-brand text-white hover:bg-brand-hover disabled:bg-brand/40"
          >
            {current ? "Update" : "Save"}
          </button>
          <button

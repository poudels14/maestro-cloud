use kernel_api::{
    ...
    Service, ServiceId, ServiceRolloutResponse, ServiceRolloutRevisions, ServiceRolloutSpec,
};
use kernel_store::{Compare, ExpectedVersion, Keyspace, Mutation, StoredValue};
use serde::Serialize;

use super::super::firewall_policies;
use super::super::service_commands::next_generation;
use super::super::service_rollout_validation::{
    ensure_managed_owner, managed_policy_id, managed_route_id, new_route, owner,
};
use super::super::services;
use super::super::write_plan::WritePlan;
use crate::{ApiError, AppState, resource};

pub(super) struct ManagedResources {
    keys: Keyspace,
...
pub(super) struct DecodedResources {
    pub(super) service: Option<Service>,
    pub(super) ingress: Option<IngressRoute>,
    pub(super) egress: Option<FirewallPolicy>,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(super) enum FrozenRolloutPolicy {
    HonorFreeze,
...
impl ManagedResources {
    pub(super) async fn load(state: &AppState, service_id: &ServiceId) -> Result<Self, ApiError> {
    ...
    pub(super) fn revisions(&self) -> ServiceRolloutRevisions {
    ...
    pub(super) fn decode(&self) -> Result<DecodedResources, ApiError> {
        Ok(DecodedResources {
